...
TESTING_GITHUB_TOKEN="make-yourself-one-in-github-personal-tokens"
...
#   (preferably as sealevelresearch-jenkins user)
...
# - https://api.travis-ci.org/repos/paulfurley/gluten-free-liverpool/key
...
function setup_fake_travis_environment {
  ...
  TRAVIS="true"
  TRAVIS_REPO_SLUG="paulfurley/gluten-free-liverpool"
